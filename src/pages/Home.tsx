      ...
      <section id="partenaires" className="py-24 bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl font-display font-bold text-brand-dark mb-8">Nos Partenaires</h3>
            <div className="text-left text-gray-600 max-w-4xl mx-auto space-y-4 leading-relaxed bg-brand-light p-8 rounded-3xl">
